        ...
        <div className="flex flex-col gap-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              ...
              <select
                ...
                className="text-sm border border-brand-neutral-40 rounded-lg px-3 py-1.5 bg-white focus:outline-none focus:ring-2 focus:ring-brand-teal-60 focus:border-brand-teal-100"
              >
          ...
          <div className="relative">
            ...
            <input
              ...
              className="block w-full pl-10 pr-10 py-2.5 border border-brand-neutral-40 rounded-lg text-sm bg-white focus:outline-none focus:ring-2 focus:ring-brand-teal-60 focus:border-brand-teal-100"
            />
            {searchQuery && (
              <button
