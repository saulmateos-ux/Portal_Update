  ...
  const bars = [
    {
      ...
      color: COLORS.neutral[700], // dark gray for gross
      isStart: true,
      delta: totalInvoiced,
    },
    {
      ...
      color: COLORS.semantic.success, // green for collections
      isDecrease: true,
    ...
    },
    {
      ...
      color: COLORS.semantic.warning, // orange for reductions
      isDecrease: true,
      delta: -reductions,
    ...
    },
    {
      ...
      color: COLORS.semantic.danger, // red for write-offs
      isDecrease: true,
      delta: -trueWriteOffs,
