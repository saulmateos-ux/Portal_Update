...
// Color scale from green (fast) to red (slow) - using semantic colors
const BUCKET_COLORS = [
  COLORS.semantic.success,      // 0-3 months - green
  COLORS.semantic.successDark,  // 3-6 months - darker green
  COLORS.semantic.warning,      // 6-12 months - yellow/amber
  COLORS.semantic.warningDark,  // 12-18 months - orange
  COLORS.semantic.danger,       // 18-24 months - red
  COLORS.semantic.dangerDark,   // 24+ months - dark red
];
