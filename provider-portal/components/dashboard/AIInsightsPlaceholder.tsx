...
export function AIInsightsPlaceholder() {
  return (
    <div className="bg-gradient-to-br from-brand-teal-20 to-brand-cta-20 rounded-lg border border-brand-teal-40 p-6 shadow-sm">
      {/* Header */}
      <div className="flex items-center gap-2 mb-4">
        <Sparkles className="h-5 w-5 text-brand-teal-100" />
        <h3 className="text-lg font-semibold text-brand-neutral-100">
          AI-Powered Insights
        </h3>
        <span className="ml-auto text-xs font-medium text-brand-teal-100 bg-brand-teal-20 px-2 py-1 rounded-full">
      ...
      {/* Coming Soon Banner */}
      <div className="mt-6 pt-4 border-t border-brand-teal-40">
        <div className="flex items-center justify-between">
          ...
          <button
            disabled
            className="text-xs font-medium text-brand-teal-100 bg-brand-teal-20 px-3 py-1.5 rounded-lg opacity-50 cursor-not-allowed"
          >
            Coming Soon
          </button>
        </div>
